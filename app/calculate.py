...
class Calculate(object):
    ...
    def __init__(self, master):
        ...
        self.master.title('Elijah Ekpen Mensah Simple Calc')
    ...
    def _create_menu(self, master):
        ...
        calc_menu.add_cascade(label='Designed by Elijah~~Nigeria', menu=config)
    ...
    def start(self):
        print('Calculator Successfully started')
